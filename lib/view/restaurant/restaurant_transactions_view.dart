        ...
        children: [
          Row(
            children: [
              ...
              Text(
                '${restaurantAmount.toStringAsFixed(2)} PKR',
                style: TextStyle(
          ...
          Row(
            children: [
              Text('Total: ${amount.toStringAsFixed(2)} PKR').muted().small(),
              const SizedBox(width: 8),
              Text('Fee: ${platformFee.toStringAsFixed(2)} PKR',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'COD fee recovery: ${debtRecovered.toStringAsFixed(2)} PKR deducted'
                      '${debtRemaining > 0 ? ' · ${debtRemaining.toStringAsFixed(2)} PKR still owed' : ' · Debt cleared'}',
                      style: const TextStyle(
                        color: Colors.orange,
                        fontSize: 10,
